...
function setup() {
	...
	log1=createSprite(400,475,200,20);
	log1.shapeColor="blue";
	log2=createSprite(500,435,20,100);
	log2.shapeColor="blue";
	log3=createSprite(300,435,20,100);
	...
	//Create a Ground
	ground = Bodies.rectangle(width/2, 465, width, 10 , {isStatic:true} );
